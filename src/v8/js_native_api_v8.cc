// Verbatim port of nodejs/node src/js_native_api_v8.cc (v22.11.0) with
// Node.js core includes ("env-inl.h", "util-inl.h", "node_internals.h",
// "node_errors.h") removed; equivalents are provided in
