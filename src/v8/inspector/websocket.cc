...
namespace napi_v8 {
    namespace inspector {
        ...
        void WsDecoder::Feed(const char *data, size_t len) { buf_.insert(buf_.end(), data, data + len); }
